        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="./page/cetak/cetak.php" method="post">
                        ...
                        <div class="col-md-4">
                            <div class="container-fluid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly="" type="date" name="tanggal_dari" id="tanggal_dari" value="<?= date("yy-m-d"); ?>" />
                                </div>
                                <div class="form-group">
                                    <label>Sampai Tanggal</label>
                                    <input class="form-control" readonly="" type="date" name="tanggal_sampai" id="tanggal_sampai" value="<?= date("yy-m-d"); ?>" />
                                </div>
                                <hr>
                                <table width="100%">
                                    <tr>
                        ...
                        <div class="col-md-4">
                            <div class="container-fluid">
                                    ...
                                    <?php if ($kategori) {
                                        foreach ($kategori as $k) { ?>
                                            <tr>
                                                ...
                                                <td style="text-align:right;"><input type="checkbox" class="checkbox checkbox_kategori" id="kategori_<?php echo $k['id_barang_kategori']; ?>" name="kategori_<?php echo $k['id_barang_kategori']; ?>"></td>
                                            </tr>
                                    <?php }
                                    } ?>
                                    <tr>
                                ...
                                <table width="100%" onclick="kategoriCapture()">
                                    <tr>
                                        <td style="white-space:nowrap"><label for="kategori_all" class="form-check-label">Pilih Semua</label></td>
                                        <td style="text-align:right;"><input type="checkbox" class="checkbox" id="kategori_all" name="kategori_all"></td>
                                    </tr>
                                </table>
                                <hr>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-primary btn-block" type="submit"><i class="fa fa-print"></i> Cetak Laporan</button>
                        </div>
                    </div>
                </form>
            </div>
